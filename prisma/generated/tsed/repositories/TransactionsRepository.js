...
let TransactionsRepository = class TransactionsRepository {
    ...
    deserialize(obj) {
        return (0, json_mapper_1.deserialize)(obj, { type: models_1.TransactionsModel, collectionType: (0, core_1.isArray)(obj) ? Array : undefined });
    }
...
], TransactionsRepository.prototype, "prisma", void 0);
